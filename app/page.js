  ...
  const projectsData = [
    {
      ...
      color: '#0a0a12',
      url: 'https://github.com/Filipe-kosher/vicente-portfolio'
    },
    {
      id: 5,
      ...
      color: '#0a0a12',
      url: 'https://github.com/Filipe-kosher/Hybrix-Site'
    },
    {
      id: 8,
      src: 'https://raw.githubusercontent.com/Filipe-kosher/mem-holocausto/refs/heads/main/screenshot.png',
      title: 'Memorial do Holocausto',
      color: '#0a0a12',
      url: 'https://mem-holocausto.vercel.app/'
    },
    {
      id: 9,
        ...
        <div className="timeline-container">
          ...
          <div className="timeline">
            ...
            <div className="timeline-item" data-year="2025">
              ...
              <div className="timeline-content">
                <div className="timeline-date" data-i18n="timeline.2025_only">2025</div>
                <h3>Calisto Agency</h3>
              </div>
            </div>
            <div className="timeline-item" data-year="2025">
              <div className="timeline-marker current"></div>
            ...
            <div className="timeline-item" data-year="2026">
              <div className="timeline-marker"></div>
              <div className="timeline-content">
                <div className="timeline-date" data-i18n="timeline.2026_only">2026</div>
                <h3>Multboost</h3>
              </div>
            </div>
          </div>
      ...
      <Script id="portfolio-init" strategy="afterInteractive">
        ...
        const i18n = {
          pt: {
            ...
            'timeline.2025_only': '2025',
            'timeline.2026_only': '2026',
            'skills.title': 'Stacks',
        ...
        if (canvas) {
          ...
          function animateNoise() {
            ...
            if (!nav.classList.contains('hidden')) generateNoise();
          ...
          if (!nav.classList.contains('hidden')) startNoise();
          ...
          const onVisibility = () => {
            ...
            else if (!nav.classList.contains('hidden')) startNoise();
          };
        ...
        let silkInstance = null;
        function initSilk(){
          silkInstance = new SilkEffect({ speed:1, scale:1, color:'#095B8B', noiseIntensity:1.5, rotation:5 });
          const heroEl = document.querySelector('.hero');
          if (heroEl && window.IntersectionObserver) {
            const heroObserver = new IntersectionObserver((entries) => {
              entries.forEach((entry) => {
                if (silkInstance) {
                  if (entry.isIntersecting && !document.hidden) silkInstance.start();
                  else silkInstance.stop();
                }
              });
            }, { threshold: 0.1 });
          ...
          document.addEventListener('visibilitychange', () => {
            ...
            if (document.hidden) silkInstance.stop();
            else silkInstance.start();
          });
        }
